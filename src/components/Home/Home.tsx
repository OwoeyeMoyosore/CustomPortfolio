...
import image4 from "../../assets/winnie4.jpg";
import image5 from "../../assets/winnie5.jpg";
import image6 from "../../assets/winnie6.png";
      ...
      <main className="main">
        ...
        <div className="grids">
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6}>
              <Items style={{ color: "#a6a6a7" }}>
                <Link to="/" className="link">
                  ...
                  <span style={{ fontSize: "1.5rem", color: " #a6a6a7" }}>
            ...
            <Grid item xs={12} sm={6}>
              <Items style={{ color: "#a6a6a7" }}>
                <Link to="https://www.instagram.com/p/Cv66dVELcCF/?igshid=MzRlODBiNWFlZA==" className="link">
            ...
            <Grid item xs={12} sm={6}>
              <Items style={{ color: "#a6a6a7" }}>
                <Link to="https://www.linkedin.com/in/agbolade-temitope-35a424150" className="link">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fab"
