...
const emailAddress = "helloomowunmiagbolade@gmail.com";
const subject = 'Consulting%20Session%20';
const body = 'Hello%20Omowunmi,%20I%20would%20like%20to%20book%20a%20one%20on%20one%20consulting%20session%20with%20you.%20';
    ...
    <section className="section">
      ...
      <main className="main">
        <section className="heading">
          ...
          <p className="sub">
            Event Coordination <span style={{ fontWeight: "900" }}> | </span>{" "}
            Face Modeling <span style={{ fontWeight: "900" }}> | </span> Brand
            Promotion
          </p>
        </section>
        ...
        <div className="image">
          ...
          <p style={{ color: "#a6a6a7" }}>
            Versatile professional with robust background in Event Management
            consulting, business development, and social media.
          </p>
        </div>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6}>
              <Items style={{ color: "#a6a6a7" }}>
                <Link
                  to="https://omowunmi-agbolade-canva-site.my.canva.site/"
                  className="link"
                  target="_blank"
                >
                  ...
                  />
                  <span className="social">View my Portfolio Here</span>{" "}
                </Link>
              </Items>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <Items style={{ color: "#a6a6a7" }}>
                <Link
                  to="https://vm.tiktok.com/ZMjaJeVHw/"
                  className="link"
                  target="_blank"
                >
                  <svg
                  ...
                  <span className="social">Find me on Tiktok</span>{" "}
                </Link>
              </Items>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <Items style={{ color: "#a6a6a7" }}>
                <Link
                  to="https://youtube.com/@Distinct_winnie?si=wNHELFZEiRQZl-Ak"
                  className="link"
                  target="_blank"
                >
                  <svg
                  ...
                  <span className="social">Find me on Youtube</span>{" "}
                </Link>
              </Items>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <Items style={{ color: "#a6a6a7" }}>
                ...
                >
                  ...
                  <span className="social">Find me on Instagram</span>{" "}
                </Link>
              </Items>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <Items style={{ color: "#a6a6a7" }}>
                ...
                >
                  ...
                  <span className="social">Connect on LinkedIn</span>{" "}
                </Link>
              </Items>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <Items style={{ color: "#a6a6a7" }}>
                <Link
                  to="https://omowunmi-agbolade-canva-site.my.canva.site/podchat-with-roddielaw-production"
                  className="link"
                  target="_blank"
                >
                  <img
            ...
            <Grid item xs={12} sm={6}>
              <Items style={{ color: "#a6a6a7" }}>
                ...
                >
                  ...
                  />
                  <span className="social">Check out some of my articles</span>{" "}
                </Link>
              </Items>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <Items style={{ color: "#a6a6a7" }}>
                <Link
                  to={`mailto:${emailAddress}?subject=${subject}&body=${body}`}
                  className="link"
